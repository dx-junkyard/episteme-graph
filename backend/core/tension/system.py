"""tension（TensionMiningAgent 系統）の WorkerSystem 宣言（設定キー・feature・上限既定の正本）。
...
SYSTEM = WorkerSystem(
    name="tension",
    model_setting_key="tension_llm_model",
    feature="learning:tension",
    log_label="tension mining",
    cost=CostSpec(
        day_setting="tension_max_calls_per_day",
        day_default=10,
        session_setting="tension_max_calls_per_session",
        session_default=3,
