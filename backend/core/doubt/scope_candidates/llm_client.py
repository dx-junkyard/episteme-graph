...
_MODEL_SETTING_KEY = "doubt_scope_llm_model"

__all__ = ["resolve_model", "parse_json_response", "ScopeCandidateLLMClient"]


def resolve_model() -> str:
    """DOUBT_SCOPE_LLM_MODEL があればそれを、無ければ fast tier のモデルを使う。"""
