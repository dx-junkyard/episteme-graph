...
class RhetoricalRoleLLMClient:
    """OpenAI JSON-mode client.

    Tests should mock generate().
    """
    ...
    def generate(self, messages: list[dict], response_schema: dict | None = None) -> dict:
        try:
            ...
            raise RuntimeError("openai package is required for RhetoricalRoleLLMClient") from exc
