...
| 軸 | 内訳 |
|---|---|
| 群（座標から導出） | 局所 0 / 構造・接続・統制 92 / （未判定） 0 |
| 処理軸 | 値あり 12（延べ）/ none 81 / unknown 0 |
| 構造軸 | 値あり 80（延べ）/ none 18 / unknown 1 |
| 接続軸 | 値あり 57（延べ）/ none 41 / unknown 0 |
| 統制軸 | 値あり 68（延べ）/ none 39 / unknown 0 |
| 値を持つ軸の数 | 0軸 0 / 1軸 13 / 2軸 63 / 3軸 15 / 4軸 1 |
| 状態 | 未解決 9 / 解決済み 77 / 保留 6 / 不成立 0 |
| 分類の確定状態 | 候補 92 / 確定 0 |
| 原因が仮説 | 2 |
| 一般化 | 固有 0 / リポジトリ内の型 24 / 一般 68 |
...
- 処理軸 低: （該当なし） ／ 中: 33 件
- 構造軸 低: [IK-0115](entries/IK-0115-confirmation-gate-bypassed-by-freeze.md) ／ 中: 50 件
- 接続軸 低: [IK-0308](entries/IK-0308-arxiv-call-budget-and-429-loop.md), [IK-0319](entries/IK-0319-no-immutable-conversation-log.md), [IK-0320](entries/IK-0320-untrusted-source-text-in-prompts.md) ／ 中: 47 件
- 統制軸 低: （該当なし） ／ 中: 48 件
...
| `information-dropped-as-unrepresentable` | 2 |  | 4 |
