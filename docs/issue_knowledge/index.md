...
| 軸 | 内訳 |
|---|---|
| 群（座標から導出） | 局所 0 / 構造・接続・統制 89 / （未判定） 0 |
| 処理軸 | 値あり 12（延べ）/ none 78 / unknown 0 |
| 構造軸 | 値あり 77（延べ）/ none 18 / unknown 1 |
| 接続軸 | 値あり 53（延べ）/ none 41 / unknown 0 |
| 統制軸 | 値あり 64（延べ）/ none 39 / unknown 0 |
| 値を持つ軸の数 | 0軸 0 / 1軸 13 / 2軸 63 / 3軸 12 / 4軸 1 |
| 状態 | 未解決 9 / 解決済み 74 / 保留 6 / 不成立 0 |
| 分類の確定状態 | 候補 89 / 確定 0 |
| 原因が仮説 | 2 |
| 一般化 | 固有 0 / リポジトリ内の型 24 / 一般 65 |
...
実際の座標: 構造=aggregation / 接続=contract（1） ／ 処理=logic / 構造=aggregation / 接続=contract / 統制=completion（1）
...
- 処理軸 低: （該当なし） ／ 中: 33 件
- 構造軸 低: [IK-0115](entries/IK-0115-confirmation-gate-bypassed-by-freeze.md) ／ 中: 48 件
...
| [docs/features/knowledge_objects_design.md](../../docs/features/knowledge_objects_design.md) | 11 |
