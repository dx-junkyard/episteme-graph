...
| 軸 | 内訳 |
|---|---|
| 群（座標から導出） | 局所 0 / 構造・接続・統制 93 / （未判定） 0 |
| 処理軸 | 値あり 12（延べ）/ none 82 / unknown 0 |
| 構造軸 | 値あり 82（延べ）/ none 18 / unknown 1 |
| 接続軸 | 値あり 57（延べ）/ none 42 / unknown 0 |
| 統制軸 | 値あり 69（延べ）/ none 39 / unknown 0 |
| 値を持つ軸の数 | 0軸 0 / 1軸 13 / 2軸 64 / 3軸 15 / 4軸 1 |
| 状態 | 未解決 9 / 解決済み 78 / 保留 6 / 不成立 0 |
| 分類の確定状態 | 候補 93 / 確定 0 |
| 原因が仮説 | 2 |
| 一般化 | 固有 0 / リポジトリ内の型 24 / 一般 69 |
...
| [IK-0006](entries/IK-0006-misconception-detection-contradicts-prompt.md) | 誤解検出が決まった語の出現に依存する一方、生成側にはその語を避けるよう指示している | 構造・接続・統制 | — | aggregation | contract | — | 確定 | 候補 | 未解決 | `contract-changed-one-side` | doc_code_diff, trace_walk | pending |
...
| [IK-0008](entries/IK-0008-consent-evidence-fabricated-by-default.md) | 確認の理由欄に既定文が入り、根拠を見た事実をサーバが定数で断言する | 構造・接続・統制 | — | representation | — | review+assignment | 確定 | 候補 | 解決済み | `default-hides-choice` | adversarial_review, invariant_audit | fail_closed, representation_change |
...
| [IK-0011](entries/IK-0011-cartridge-id-not-propagated.md) | 分野の指定が後段の正規化へ伝わらず、既定の語彙が概念名を上書きする | 構造・接続・統制 | — | representation | condition+meaning | — | 確定 | 候補 | 解決済み | `condition-not-propagated` | trace_walk, data_inspection | carry_through, representation_change |
...
| [IK-0013](entries/IK-0013-state-changes-without-audit.md) | 教材の物理削除・版の取り込み・原稿の保存が、監査の記帳を伴わずに状態を変える | 構造・接続・統制 | — | — | — | review | 確定 | 候補 | 解決済み | `unaudited-write-path` | inventory, invariant_audit | explicit_contract, guardrail_fix |
...
| [IK-0016](entries/IK-0016-design-docs-lag-behind-implementation.md) | 設計書の「非スコープ」や索引が、別の層で実装済みの事実に追随しない | 構造・接続・統制 | — | aggregation | — | completion+assignment | 確定 | 候補 | 解決済み | `doc-drifts-from-code` | doc_code_diff, inventory | doc_correction, explicit_contract |
...
| [IK-0018](entries/IK-0018-diff-substring-false-negative.md) | 自由記述の照合が概念名の部分文字列一致で、言い換えを「言及が無い」と断定する | 構造・接続・統制 | logic+wording | — | meaning | — | 確定 | 候補 | 未解決 | `substring-match-false-positive` | invariant_audit, trace_walk | pending |
...
| [IK-0020](entries/IK-0020-version-pin-not-reaching-document-assets.md) | 版のピン留めが教材側の成果物へ伝わらず、読み手は常に最新を読む | 構造・接続・統制 | — | decomposition | version+condition | — | 確定 | 候補 | 未解決 | `condition-not-propagated` | boundary_walk, inventory | pending |
...
| [IK-0022](entries/IK-0022-k-anonymity-threshold-ignores-group-size.md) | 匿名であることを件数の閾値だけで判定し、小さな集団では匿名にならない | 構造・接続・統制 | — | representation | — | review+completion | 確定 | 候補 | 保留 | `completion-defined-by-proxy` | adversarial_review, external_constraint | deferred_decision |
| [IK-0101](entries/IK-0101-input-cap-truncates-head-silently.md) | 入力上限の超過を先頭切り捨てで処理し、捨てた範囲をどこにも報告しない | 構造・接続・統制 | — | representation | meaning | budget+completion | 確定 | 候補 | 解決済み | `information-dropped-as-unrepresentable` | data_inspection, trace_walk | order_and_budget, canonical_source |
...
| [IK-0105](entries/IK-0105-artifact-blob-is-source-of-truth.md) | 生成ログの JSONB blob が知識の正本で、関係テーブルがその劣化投影になっている | 構造・接続・統制 | — | representation+decomposition | information | — | 確定 | 候補 | 解決済み | `projection-mistaken-for-source` | data_inspection, inventory | canonical_source, representation_change |
...
| [IK-0108](entries/IK-0108-reanalysis-deletes-teacher-decisions.md) | 再解析が成果を削除して作り直すため、教員の確定がその都度消える | 構造・接続・統制 | input_handling | representation | — | resume+review | 確定 | 候補 | 解決済み | `reexecution-overwrites-human-decision` | boundary_walk, data_inspection | state_transition, explicit_contract |
...
| [IK-0110](entries/IK-0110-import-replace-supersedes-approved-rows.md) | 束の取り込みの置き換え指定が、教員が確定した行まで表示対象から外す | 構造・接続・統制 | — | — | — | review+resume | 確定 | 候補 | 解決済み | `reexecution-overwrites-human-decision` | adversarial_review, invariant_audit | state_transition, explicit_contract |
| [IK-0111](entries/IK-0111-dryrun-and-apply-not-same-payload.md) | 事前確認と確定が同じ入力である保証が無く、一括確定の記帳も無かった | 構造・接続・統制 | — | — | target | ordering+review | 確定 | 候補 | 解決済み | `gate-position-wrong` | adversarial_review, invariant_audit | required_argument, explicit_contract |
...
| [IK-0114](entries/IK-0114-positional-fallback-presented-as-evidence.md) | 接続できなかった箇所の出典を位置で代入し、根拠の強さまで底上げしていた | 構造・接続・統制 | logic | representation | meaning | — | 確定 | 候補 | 解決済み | `fallback-fabricates-missing-link` | data_inspection, invariant_audit | fail_closed, explicit_contract |
...
| [IK-0116](entries/IK-0116-human-gate-without-candidates.md) | 人の確定を要する仕組みに候補を供給する経路が無く、受け皿が空のまま死んでいた | 構造・接続・統制 | — | — | — | assignment | 確定 | 候補 | 解決済み | `last-mile-missing` | inventory, data_inspection | responsibility_move, state_transition |
...
| [IK-0119](entries/IK-0119-visibility-gate-missing-on-new-paths.md) | 新しく足した候補表・文脈組み立て・記帳の経路に可視性と編集権限のゲートが付かない | 構造・接続・統制 | — | responsibility | condition | — | 確定 | 候補 | 解決済み | `condition-not-propagated` | adversarial_review, boundary_walk | carry_through, fail_closed |
| [IK-0120](entries/IK-0120-guardrail-blind-to-dynamic-table-names.md) | 規律を守るガードレールが動的な表名と新しい経路を覆わず、静かに破られていた | 構造・接続・統制 | logic | aggregation | — | review | 確定 | 候補 | 解決済み | `guardrail-does-not-cover-new-path` | adversarial_review, inventory | canonical_source, guardrail_fix |
...
| [IK-0201](entries/IK-0201-publish-route-contract-one-sided.md) | 公開手段の契約をサーバ側だけ差し替え、呼び出し側と案内が旧契約のまま残って学習者がコースに到達できない | 構造・接続・統制 | logic | aggregation | contract | completion | 確定 | 候補 | 解決済み | `contract-changed-one-side` | doc_code_diff, inventory | canonical_source, explicit_contract |
...
| [IK-0204](entries/IK-0204-layers-built-but-unwired.md) | 層ごと作られた処理が画面に配線されず、誰も呼ばないまま完成として扱われる | 構造・接続・統制 | — | responsibility | information | completion | 確定 | 候補 | 解決済み | `available-but-unwired` | inventory, doc_code_diff | carry_through, responsibility_move |
...
| [IK-0207](entries/IK-0207-partial-save-full-replace.md) | 一部だけ編集した保存が設定全体を書き戻し、触っていない項目を既定値で上書きする | 構造・接続・統制 | — | representation | contract | — | 確定 | 候補 | 解決済み | `full-update-clobbers-unrelated-fields` | boundary_walk | representation_change, explicit_contract |
...
| [IK-0301](entries/IK-0301-approval-full-update-clobbers-component.md) | コンポーネント承認を「読み出し→全体書き戻し」で行い、CHECK 違反と出所情報の破壊を招いた | 構造・接続・統制 | — | representation+decomposition | contract | review | 確定 | 候補 | 解決済み | `full-update-clobbers-unrelated-fields` | adversarial_review, trace_walk | representation_change, guardrail_fix |
...
| [IK-0305](entries/IK-0305-hedged-every-sentence-response.md) | 不確かさを文ごとの留保で表す契約にしたため、応答が読めず聞けないものになった | 構造・接続・統制 | wording | representation | condition | — | 確定 | 候補 | 解決済み | `wording-mismatch` | symptom_report, invariant_audit | representation_change, canonical_source |
...
| [IK-0308](entries/IK-0308-arxiv-call-budget-and-429-loop.md) | 外部 API を操作のたびに引き直し、制限を受けたあとも人の操作で窓が延び続ける | 構造・接続・統制 | — | representation | — | budget+resume | 確定 | 候補 | 解決済み | `external-budget-exceeded` | external_constraint, data_inspection | order_and_budget, representation_change |
...
| [IK-0312](entries/IK-0312-casual-mode-has-no-text-entry.md) | 会話の調子を利用者に選ばせる設計のまま、テキスト側にその入口が用意されていなかった | 構造・接続・統制 | — | responsibility | condition | assignment | 確定 | 候補 | 解決済み | `available-but-unwired` | inventory, doc_code_diff | responsibility_move, explicit_contract |
...
| [IK-0316](entries/IK-0316-write-path-checks-role-only.md) | 書き込み経路が役割だけを見て、対象の所有条件を確かめていなかった | 構造・接続・統制 | — | aggregation | condition | assignment | 確定 | 候補 | 解決済み | `condition-not-propagated` | inventory, boundary_walk | fail_closed, canonical_source |
...
| [IK-0318](entries/IK-0318-figure-annotations-silently-discarded.md) | 許容されない種別の候補注釈が黙って捨てられ、生成側にも利用者にも伝わらない | 構造・接続・統制 | — | representation | contract | completion | 確定 | 候補 | 未解決 | `information-dropped-as-unrepresentable` | inventory, trace_walk | pending |
...
| [IK-0320](entries/IK-0320-untrusted-source-text-in-prompts.md) | 第三者が書いた資料本文が、指示と区別されないままプロンプトへ流れ込む | 構造・接続・統制 | input_handling | representation | — | review | 確定 | 候補 | 未解決 | `untrusted-input-reaches-instruction` | inventory, invariant_audit | explicit_contract, pending |
| [IK-0321](entries/IK-0321-display-and-audio-use-different-sources.md) | 表示と読み上げが別のコンテンツと別の分割単位を使い、同期が近似にしかならない | 構造・接続・統制 | — | representation+aggregation | meaning | — | 確定 | 候補 | 解決済み | `duplicate-canonical-sources` | symptom_report, boundary_walk | representation_change, canonical_source |
| [IK-0322](entries/IK-0322-audio-task-completes-with-skipped-slides.md) | 前提が揃わないまま一括生成を始められ、飛ばされた分があっても完了として扱われる | 構造・接続・統制 | — | aggregation | — | completion+ordering | 確定 | 候補 | 解決済み | `completion-defined-by-proxy` | boundary_walk, symptom_report | canonical_source, fail_closed |
| [IK-0323](entries/IK-0323-duplicate-agent-id-collapsed-by-key-map.md) | 衝突解消の結果を agent ID で引く写像で配るため、同名の別項目が一つに潰れ永続化が落ちる | 構造・接続・統制 | — | representation | contract | — | 確定 | 候補 | 解決済み | `id-unique-only-within-inner-scope` | reproduction, trace_walk | representation_change, explicit_contract |
| [IK-0324](entries/IK-0324-sql-percent-escape-written-for-one-consumer.md) | migration SQL が一方の実行経路（psycopg2）のエスケープ規約で書かれ、もう一方（psql）の CI で落ちる | 構造・接続・統制 | — | aggregation | contract | review | 確定 | 候補 | 解決済み | `contract-changed-one-side` | guardrail_failure, trace_walk | canonical_source, guardrail_fix |
| [IK-0325](entries/IK-0325-improvement-cycle-canonical-outside-repo.md) | 改善サイクルの手順の正本が実行者の外部記憶にあり、サイクル自身の課題を記帳する対象範囲と層の語彙が無い | 構造・接続・統制 | — | representation+aggregation | — | review | 確定 | 候補 | 解決済み | `information-dropped-as-unrepresentable` | invariant_audit, inventory | canonical_source, explicit_contract |
| [IK-0326](entries/IK-0326-route-registry-tests-walk-app-routes-across-fastapi-versions.md) | ルート登録検査が app.routes の内部表現に依存し、FastAPI の版が変わると prefix 抜きのパスを見て静かに空振りする | 構造・接続・統制 | — | aggregation | contract+version | review | 確定 | 候補 | 解決済み | `guardrail-does-not-cover-new-path` | guardrail_failure, reproduction | canonical_source, guardrail_fix |
| [IK-0327](entries/IK-0327-ci-only-tests-invisible-locally-and-blocked-by-earlier-step.md) | CI でしか走らないテスト（node・DB 依存）がローカルでは静かにスキップされ、CI が前段で止まっていたため失敗が見えなかった | 構造・接続・統制 | — | aggregation | version | review+completion | 確定 | 候補 | 解決済み | `guardrail-does-not-cover-new-path` | guardrail_failure, trace_walk | carry_through, guardrail_fix |
...
- `processing.input_handling`: [IK-0108](entries/IK-0108-reanalysis-deletes-teacher-decisions.md), [IK-0320](entries/IK-0320-untrusted-source-text-in-prompts.md)
- `processing.logic`: [IK-0018](entries/IK-0018-diff-substring-false-negative.md), [IK-0103](entries/IK-0103-alias-substring-match-injects-concept.md), [IK-0107](entries/IK-0107-id-unique-only-within-inner-scope.md), [IK-0114](entries/IK-0114-positional-fallback-presented-as-evidence.md), [IK-0120](entries/IK-0120-guardrail-blind-to-dynamic-table-names.md), [IK-0201](entries/IK-0201-publish-route-contract-one-sided.md), [IK-0306](entries/IK-0306-layout-levels-from-vocabulary.md)
- `processing.resource`: [IK-0317](entries/IK-0317-silent-save-failure.md)
- `processing.wording`: [IK-0018](entries/IK-0018-diff-substring-false-negative.md), [IK-0305](entries/IK-0305-hedged-every-sentence-response.md)
...
- `structure.representation`: [IK-0002](entries/IK-0002-reanalysis-physical-delete-cascade.md), [IK-0005](entries/IK-0005-misconception-memo-ai-confirmed.md), [IK-0007](entries/IK-0007-approval-erases-analysis-warnings.md), [IK-0008](entries/IK-0008-consent-evidence-fabricated-by-default.md), [IK-0009](entries/IK-0009-rejection-is-second-class.md), [IK-0011](entries/IK-0011-cartridge-id-not-propagated.md), [IK-0014](entries/IK-0014-external-llm-transfer-undeclared.md), [IK-0017](entries/IK-0017-phase-label-means-four-things.md), [IK-0019](entries/IK-0019-claim-objects-not-persisted.md), [IK-0022](entries/IK-0022-k-anonymity-threshold-ignores-group-size.md), [IK-0101](entries/IK-0101-input-cap-truncates-head-silently.md), [IK-0104](entries/IK-0104-untyped-value-crosses-stage-boundary.md), [IK-0105](entries/IK-0105-artifact-blob-is-source-of-truth.md), [IK-0106](entries/IK-0106-agent-id-derived-from-position.md), [IK-0107](entries/IK-0107-id-unique-only-within-inner-scope.md), [IK-0108](entries/IK-0108-reanalysis-deletes-teacher-decisions.md), [IK-0109](entries/IK-0109-chunk-delete-cascades-into-claims.md), [IK-0112](entries/IK-0112-document-reference-without-integrity.md), [IK-0113](entries/IK-0113-learning-unit-undefined.md), [IK-0114](entries/IK-0114-positional-fallback-presented-as-evidence.md), [IK-0118](entries/IK-0118-atlas-node-id-replaced-every-version.md), [IK-0206](entries/IK-0206-fail-closed-silence.md), [IK-0207](entries/IK-0207-partial-save-full-replace.md), [IK-0212](entries/IK-0212-enumerating-guardrails-miss.md), [IK-0214](entries/IK-0214-course-completion-by-proxy.md), [IK-0216](entries/IK-0216-vision-model-setting-duplicated.md), [IK-0301](entries/IK-0301-approval-full-update-clobbers-component.md), [IK-0303](entries/IK-0303-graph-native-id-vs-db-uuid.md), [IK-0304](entries/IK-0304-derived-claims-not-persisted.md), [IK-0305](entries/IK-0305-hedged-every-sentence-response.md), [IK-0306](entries/IK-0306-layout-levels-from-vocabulary.md), [IK-0307](entries/IK-0307-degraded-notice-not-rendered.md), [IK-0308](entries/IK-0308-arxiv-call-budget-and-429-loop.md), [IK-0313](entries/IK-0313-threshold-reused-across-regimes.md), [IK-0315](entries/IK-0315-replay-runner-vs-history.md), [IK-0318](entries/IK-0318-figure-annotations-silently-discarded.md), [IK-0319](entries/IK-0319-no-immutable-conversation-log.md), [IK-0320](entries/IK-0320-untrusted-source-text-in-prompts.md), [IK-0321](entries/IK-0321-display-and-audio-use-different-sources.md), [IK-0323](entries/IK-0323-duplicate-agent-id-collapsed-by-key-map.md), [IK-0325](entries/IK-0325-improvement-cycle-canonical-outside-repo.md)
- `structure.responsibility`: [IK-0112](entries/IK-0112-document-reference-without-integrity.md), [IK-0119](entries/IK-0119-visibility-gate-missing-on-new-paths.md), [IK-0204](entries/IK-0204-layers-built-but-unwired.md), [IK-0205](entries/IK-0205-decision-ui-without-candidates.md), [IK-0218](entries/IK-0218-element-rendering-split.md), [IK-0223](entries/IK-0223-call-budget-counted-in-process.md), [IK-0302](entries/IK-0302-frozen-graph-status-beats-live.md), [IK-0309](entries/IK-0309-structure-not-in-answer-prompt.md), [IK-0310](entries/IK-0310-contextvar-lost-across-generator.md), [IK-0311](entries/IK-0311-tests-pin-function-body-text.md), [IK-0312](entries/IK-0312-casual-mode-has-no-text-entry.md)
- `structure.decomposition`: [IK-0020](entries/IK-0020-version-pin-not-reaching-document-assets.md), [IK-0105](entries/IK-0105-artifact-blob-is-source-of-truth.md), [IK-0113](entries/IK-0113-learning-unit-undefined.md), [IK-0122](entries/IK-0122-persistence-split-across-transactions.md), [IK-0217](entries/IK-0217-entry-points-proliferate.md), [IK-0301](entries/IK-0301-approval-full-update-clobbers-component.md)
- `structure.aggregation`: [IK-0006](entries/IK-0006-misconception-detection-contradicts-prompt.md), [IK-0015](entries/IK-0015-untrusted-source-boundary-undeclared.md), [IK-0016](entries/IK-0016-design-docs-lag-behind-implementation.md), [IK-0021](entries/IK-0021-no-canonical-policy-for-personal-data.md), [IK-0103](entries/IK-0103-alias-substring-match-injects-concept.md), [IK-0120](entries/IK-0120-guardrail-blind-to-dynamic-table-names.md), [IK-0201](entries/IK-0201-publish-route-contract-one-sided.md), [IK-0203](entries/IK-0203-guidance-registry-drift.md), [IK-0208](entries/IK-0208-bulk-regeneration-leaves-stale-audio.md), [IK-0211](entries/IK-0211-destructive-action-without-confirmation.md), [IK-0215](entries/IK-0215-entry-scope-narrower-than-implied.md), [IK-0216](entries/IK-0216-vision-model-setting-duplicated.md), [IK-0218](entries/IK-0218-element-rendering-split.md), [IK-0219](entries/IK-0219-canonical-doc-not-in-repo.md), [IK-0220](entries/IK-0220-count-values-diverge.md), [IK-0222](entries/IK-0222-same-judgment-reimplemented-per-layer.md), [IK-0314](entries/IK-0314-canonical-source-split.md), [IK-0316](entries/IK-0316-write-path-checks-role-only.md), [IK-0321](entries/IK-0321-display-and-audio-use-different-sources.md), [IK-0322](entries/IK-0322-audio-task-completes-with-skipped-slides.md), [IK-0324](entries/IK-0324-sql-percent-escape-written-for-one-consumer.md), [IK-0325](entries/IK-0325-improvement-cycle-canonical-outside-repo.md), [IK-0326](entries/IK-0326-route-registry-tests-walk-app-routes-across-fastapi-versions.md), [IK-0327](entries/IK-0327-ci-only-tests-invisible-locally-and-blocked-by-earlier-step.md)
...
- `governance.ordering`: [IK-0111](entries/IK-0111-dryrun-and-apply-not-same-payload.md), [IK-0322](entries/IK-0322-audio-task-completes-with-skipped-slides.md)
...
- `governance.assignment`: [IK-0001](entries/IK-0001-llm-decides-check-pass.md), [IK-0003](entries/IK-0003-lecture-silent-adaptation.md), [IK-0005](entries/IK-0005-misconception-memo-ai-confirmed.md), [IK-0008](entries/IK-0008-consent-evidence-fabricated-by-default.md), [IK-0010](entries/IK-0010-default-domain-hidden-at-entry.md), [IK-0016](entries/IK-0016-design-docs-lag-behind-implementation.md), [IK-0021](entries/IK-0021-no-canonical-policy-for-personal-data.md), [IK-0116](entries/IK-0116-human-gate-without-candidates.md), [IK-0121](entries/IK-0121-pipeline-creates-candidate-rows-in-human-registry.md), [IK-0213](entries/IK-0213-owner-flag-absent-from-response.md), [IK-0312](entries/IK-0312-casual-mode-has-no-text-entry.md), [IK-0316](entries/IK-0316-write-path-checks-role-only.md)
- `governance.review`: [IK-0005](entries/IK-0005-misconception-memo-ai-confirmed.md), [IK-0007](entries/IK-0007-approval-erases-analysis-warnings.md), [IK-0008](entries/IK-0008-consent-evidence-fabricated-by-default.md), [IK-0009](entries/IK-0009-rejection-is-second-class.md), [IK-0012](entries/IK-0012-export-gate-by-role-only.md), [IK-0013](entries/IK-0013-state-changes-without-audit.md), [IK-0014](entries/IK-0014-external-llm-transfer-undeclared.md), [IK-0015](entries/IK-0015-untrusted-source-boundary-undeclared.md), [IK-0022](entries/IK-0022-k-anonymity-threshold-ignores-group-size.md), [IK-0108](entries/IK-0108-reanalysis-deletes-teacher-decisions.md), [IK-0110](entries/IK-0110-import-replace-supersedes-approved-rows.md), [IK-0111](entries/IK-0111-dryrun-and-apply-not-same-payload.md), [IK-0115](entries/IK-0115-confirmation-gate-bypassed-by-freeze.md), [IK-0120](entries/IK-0120-guardrail-blind-to-dynamic-table-names.md), [IK-0121](entries/IK-0121-pipeline-creates-candidate-rows-in-human-registry.md), [IK-0203](entries/IK-0203-guidance-registry-drift.md), [IK-0211](entries/IK-0211-destructive-action-without-confirmation.md), [IK-0212](entries/IK-0212-enumerating-guardrails-miss.md), [IK-0217](entries/IK-0217-entry-points-proliferate.md), [IK-0219](entries/IK-0219-canonical-doc-not-in-repo.md), [IK-0220](entries/IK-0220-count-values-diverge.md), [IK-0221](entries/IK-0221-explanation-docs-have-no-update-rule.md), [IK-0301](entries/IK-0301-approval-full-update-clobbers-component.md), [IK-0311](entries/IK-0311-tests-pin-function-body-text.md), [IK-0320](entries/IK-0320-untrusted-source-text-in-prompts.md), [IK-0324](entries/IK-0324-sql-percent-escape-written-for-one-consumer.md), [IK-0325](entries/IK-0325-improvement-cycle-canonical-outside-repo.md), [IK-0326](entries/IK-0326-route-registry-tests-walk-app-routes-across-fastapi-versions.md), [IK-0327](entries/IK-0327-ci-only-tests-invisible-locally-and-blocked-by-earlier-step.md)
- `governance.completion`: [IK-0001](entries/IK-0001-llm-decides-check-pass.md), [IK-0004](entries/IK-0004-prerequisite-mastery-by-contact.md), [IK-0016](entries/IK-0016-design-docs-lag-behind-implementation.md), [IK-0022](entries/IK-0022-k-anonymity-threshold-ignores-group-size.md), [IK-0101](entries/IK-0101-input-cap-truncates-head-silently.md), [IK-0102](entries/IK-0102-completeness-gate-by-count-proxy.md), [IK-0115](entries/IK-0115-confirmation-gate-bypassed-by-freeze.md), [IK-0201](entries/IK-0201-publish-route-contract-one-sided.md), [IK-0204](entries/IK-0204-layers-built-but-unwired.md), [IK-0214](entries/IK-0214-course-completion-by-proxy.md), [IK-0221](entries/IK-0221-explanation-docs-have-no-update-rule.md), [IK-0317](entries/IK-0317-silent-save-failure.md), [IK-0318](entries/IK-0318-figure-annotations-silently-discarded.md), [IK-0319](entries/IK-0319-no-immutable-conversation-log.md), [IK-0322](entries/IK-0322-audio-task-completes-with-skipped-slides.md), [IK-0327](entries/IK-0327-ci-only-tests-invisible-locally-and-blocked-by-earlier-step.md)
...
- [IK-0115](entries/IK-0115-confirmation-gate-bypassed-by-freeze.md): 構造
...
実際の座標: 処理=logic+wording / 接続=meaning（1） ／ 処理=logic / 構造=aggregation（1）
...
実際の座標: 処理=wording / 構造=representation / 接続=condition（1）
...
実際の座標: 処理=logic / 構造=representation（1） ／ 構造=representation / 接続=contract（1）
...
実際の座標: 構造=representation+decomposition / 接続=information（1）
...
実際の座標: 構造=representation / 接続=information（3） ／ 構造=representation / 統制=review（1） ／ 構造=representation / 接続=meaning / 統制=budget+completion（1）
...
実際の座標: 構造=representation / 接続=contract（1） ／ 構造=representation+decomposition / 接続=contract / 統制=review（1）
...
実際の座標: 構造=representation / 接続=condition+meaning（1） ／ 構造=decomposition / 接続=version+condition（1） ／ 構造=responsibility / 接続=condition（1）
...
実際の座標: 構造=aggregation / 接続=contract（1） ／ 処理=logic / 構造=aggregation / 接続=contract / 統制=completion（1） ／ 構造=aggregation / 接続=contract / 統制=review（1）
...
実際の座標: 処理=logic / 構造=representation / 接続=meaning（1）
...
実際の座標: 処理=input_handling / 構造=representation / 統制=review（1）
...
実際の座標: 接続=contract+version（1） ／ 構造=responsibility / 接続=information / 統制=completion（1） ／ 構造=representation / 接続=information（1）
...
実際の座標: 統制=assignment（1） ／ 構造=responsibility / 接続=information（1）
...
実際の座標: 構造=representation / 統制=review+assignment（1） ／ 接続=condition / 統制=assignment（1）
...
実際の座標: 接続=information / 統制=completion（2） ／ 構造=representation / 統制=review+completion（1） ／ 構造=representation / 統制=completion（1）
...
実際の座標: 処理=input_handling / 構造=representation / 統制=resume+review（1） ／ 統制=review+resume（1）
...
実際の座標: 接続=target / 統制=ordering+review（1）
...
実際の座標: 構造=responsibility / 統制=budget（1） ／ 構造=representation / 統制=budget+resume（1）
...
実際の座標: 構造=aggregation / 統制=review（1） ／ 処理=logic / 構造=aggregation / 統制=review（1） ／ 構造=representation / 統制=review（1）
...
実際の座標: 統制=review（1） ／ 構造=? / 統制=review+completion（1） ／ 構造=representation / 統制=completion（1）
...
実際の座標: 構造=aggregation / 統制=completion+assignment（1） ／ 構造=aggregation / 統制=review（1） ／ 統制=review+completion（1）
...
- `guardrail_failure`: [IK-0015](entries/IK-0015-untrusted-source-boundary-undeclared.md), [IK-0212](entries/IK-0212-enumerating-guardrails-miss.md), [IK-0311](entries/IK-0311-tests-pin-function-body-text.md), [IK-0315](entries/IK-0315-replay-runner-vs-history.md), [IK-0324](entries/IK-0324-sql-percent-escape-written-for-one-consumer.md), [IK-0326](entries/IK-0326-route-registry-tests-walk-app-routes-across-fastapi-versions.md), [IK-0327](entries/IK-0327-ci-only-tests-invisible-locally-and-blocked-by-earlier-step.md)
- `reproduction`: [IK-0107](entries/IK-0107-id-unique-only-within-inner-scope.md), [IK-0109](entries/IK-0109-chunk-delete-cascades-into-claims.md), [IK-0302](entries/IK-0302-frozen-graph-status-beats-live.md), [IK-0323](entries/IK-0323-duplicate-agent-id-collapsed-by-key-map.md), [IK-0326](entries/IK-0326-route-registry-tests-walk-app-routes-across-fastapi-versions.md)
...
- `admin_copilot`: [IK-0203](entries/IK-0203-guidance-registry-drift.md), [IK-0212](entries/IK-0212-enumerating-guardrails-miss.md), [IK-0217](entries/IK-0217-entry-points-proliferate.md), [IK-0319](entries/IK-0319-no-immutable-conversation-log.md), [IK-0326](entries/IK-0326-route-registry-tests-walk-app-routes-across-fastapi-versions.md)
...
- `cycle_triage`: [IK-0325](entries/IK-0325-improvement-cycle-canonical-outside-repo.md)
...
- `deployment`: [IK-0324](entries/IK-0324-sql-percent-escape-written-for-one-consumer.md)
...
- `docs`: [IK-0016](entries/IK-0016-design-docs-lag-behind-implementation.md), [IK-0017](entries/IK-0017-phase-label-means-four-things.md), [IK-0219](entries/IK-0219-canonical-doc-not-in-repo.md), [IK-0220](entries/IK-0220-count-values-diverge.md), [IK-0221](entries/IK-0221-explanation-docs-have-no-update-rule.md), [IK-0325](entries/IK-0325-improvement-cycle-canonical-outside-repo.md)
...
- `graph_review`: [IK-0007](entries/IK-0007-approval-erases-analysis-warnings.md), [IK-0009](entries/IK-0009-rejection-is-second-class.md), [IK-0019](entries/IK-0019-claim-objects-not-persisted.md), [IK-0306](entries/IK-0306-layout-levels-from-vocabulary.md), [IK-0309](entries/IK-0309-structure-not-in-answer-prompt.md), [IK-0327](entries/IK-0327-ci-only-tests-invisible-locally-and-blocked-by-earlier-step.md)
...
- `migrations_db`: [IK-0109](entries/IK-0109-chunk-delete-cascades-into-claims.md), [IK-0112](entries/IK-0112-document-reference-without-integrity.md), [IK-0314](entries/IK-0314-canonical-source-split.md), [IK-0315](entries/IK-0315-replay-runner-vs-history.md), [IK-0324](entries/IK-0324-sql-percent-escape-written-for-one-consumer.md)
...
- `tests_guardrails`: [IK-0120](entries/IK-0120-guardrail-blind-to-dynamic-table-names.md), [IK-0212](entries/IK-0212-enumerating-guardrails-miss.md), [IK-0220](entries/IK-0220-count-values-diverge.md), [IK-0311](entries/IK-0311-tests-pin-function-body-text.md), [IK-0324](entries/IK-0324-sql-percent-escape-written-for-one-consumer.md), [IK-0326](entries/IK-0326-route-registry-tests-walk-app-routes-across-fastapi-versions.md), [IK-0327](entries/IK-0327-ci-only-tests-invisible-locally-and-blocked-by-earlier-step.md)
...
- 代表 [IK-0107](entries/IK-0107-id-unique-only-within-inner-scope.md): [IK-0107](entries/IK-0107-id-unique-only-within-inner-scope.md) 内側のスコープでしか一意でない識別子を、外側のキーとして使っている / [IK-0323](entries/IK-0323-duplicate-agent-id-collapsed-by-key-map.md) 衝突解消の結果を agent ID で引く写像で配るため、同名の別項目が一つに潰れ永続化が落ちる
...
## 11. 確信度が低い軸（分類レビュー・再評価の入口）

- 処理軸 低: （該当なし） ／ 中: 33 件
- 構造軸 低: [IK-0115](entries/IK-0115-confirmation-gate-bypassed-by-freeze.md) ／ 中: 51 件
- 接続軸 低: [IK-0308](entries/IK-0308-arxiv-call-budget-and-429-loop.md), [IK-0319](entries/IK-0319-no-immutable-conversation-log.md), [IK-0320](entries/IK-0320-untrusted-source-text-in-prompts.md) ／ 中: 48 件
- 統制軸 低: （該当なし） ／ 中: 48 件

## 12. 新設の提案（確信度の低い軸から出た「新しい軸か値が要るか」への答え）

同じ種別・同じ軸・同じ相手の提案を束ねる。確信度 high が 3 件以上の束は**設定候補**。人が taxonomy §2 に暫定の値（または軸）として足すまで体系は変わらない。至らない束も消さない。

### 束: 軸 `connection` に値 ／ 相手 `connection.meaning`, `governance.assignment`

提案 3 件（high 0）

- [IK-0001](entries/IK-0001-llm-decides-check-pass.md)（中）: 前段が候補・推定・申告として出した値が、後段では確定した事実として扱われ、確からしさの身分が段階をまたいで格上げされる
- [IK-0005](entries/IK-0005-misconception-memo-ai-confirmed.md)（中）: 前段が候補・推定・申告として出した値が、後段では確定した事実として扱われ、確からしさの身分が段階をまたいで格上げされる
- [IK-0008](entries/IK-0008-consent-evidence-fabricated-by-default.md)（中）: 前段が候補・推定・申告として出した値が、後段では確定した事実として扱われ、確からしさの身分が段階をまたいで格上げされる

### 束: 軸 `governance` に値 ／ 相手 `connection.information`, `governance.completion`

提案 3 件（high 0）

- [IK-0101](entries/IK-0101-input-cap-truncates-head-silently.md)（中）: 機械が何を処理し何を処理しなかったか、またその操作で何が失われるかを、判断する人へ開示する義務が置かれているかを区別する値
- [IK-0110](entries/IK-0110-import-replace-supersedes-approved-rows.md)（中）: 機械が何を処理し何を処理しなかったか、またその操作で何が失われるかを、判断する人へ開示する義務が置かれているかを区別する値
- [IK-0115](entries/IK-0115-confirmation-gate-bypassed-by-freeze.md)（中）: 機械が何を処理し何を処理しなかったか、またその操作で何が失われるかを、判断する人へ開示する義務が置かれているかを区別する値

### 束: 軸 `governance` に値 ／ 相手 `governance.assignment`, `governance.review`

提案 2 件（high 0）

- [IK-0009](entries/IK-0009-rejection-is-second-class.md)（中）: 記録された当人が、その記録の扱いを後から変える手続が用意されていない
- [IK-0021](entries/IK-0021-no-canonical-policy-for-personal-data.md)（中）: 記録された当人が、その記録の扱いを後から変える手続が用意されていない

### 束: 軸 `connection` に値 ／ 相手 `connection.contract`, `connection.information`

提案 2 件（high 0）

- [IK-0204](entries/IK-0204-layers-built-but-unwired.md)（中）: 前段と後段をつなぐ経路そのものが用意されず、後段が前段の成果を一度も受け取らない
- [IK-0205](entries/IK-0205-decision-ui-without-candidates.md)（中）: 前段と後段をつなぐ経路そのものが用意されず、後段が前段の成果を一度も受け取らない

### 束: 軸 `governance` に値 ／ 相手 `governance.review`, `structure.representation`

提案 1 件（high 0）

- [IK-0014](entries/IK-0014-external-llm-transfer-undeclared.md)（中）: 実際に起きていることを、影響を受ける当事者へ宣言する手続が定まっていない

### 束: 軸 `structure` に値 ／ 相手 `connection.version`, `structure.decomposition`

提案 1 件（high 0）

- [IK-0020](entries/IK-0020-version-pin-not-reaching-document-assets.md)（低）: 保護や固定の単位が、その対象が成り立つために必要としている依存の範囲を覆わない

### 束: 軸 `connection` に値 ／ 相手 `connection.target`, `structure.representation`

提案 1 件（high 0）

- [IK-0109](entries/IK-0109-chunk-delete-cascades-into-claims.md)（低）: ある操作の影響が、呼び出した側が宣言した対象の外へ、参照の連鎖によって自動的に広がることを区別する値

### 束: 軸 `governance` に値 ／ 相手 `governance.review`, `structure.decomposition`

提案 1 件（high 0）

- [IK-0217](entries/IK-0217-entry-points-proliferate.md)（中）: 一つひとつの追加はどれも妥当でも、積み上がった総量を見る基準と担い手が無く、全体が単調に悪化する

### 束: 軸 `structure` に値 ／ 相手 `structure.decomposition`, `structure.representation`

提案 1 件（high 0）

- [IK-0301](entries/IK-0301-approval-full-update-clobbers-component.md)（中）: 操作の意味が及ぶ範囲と、実際に書き換える範囲が対応していない

### 束: 軸 `governance` に値 ／ 相手 `governance.review`, `structure.responsibility`

提案 1 件（high 0）

- [IK-0311](entries/IK-0311-tests-pin-function-body-text.md)（中）: 自動化された確認の手続が、守りたい性質ではなく実装の形に結び付いている

### 束: 軸 `governance` に値 ／ 相手 `governance.completion`, `governance.review`

提案 1 件（high 0）

- [IK-0319](entries/IK-0319-no-immutable-conversation-log.md)（中）: 後から経緯を示す義務が要件として置かれておらず、記録の有無が設計の判断に現れない

### 束: 軸 `connection` に値 ／ 相手 `connection.contract`, `connection.meaning`

提案 1 件（high 0）

- [IK-0320](entries/IK-0320-untrusted-source-text-in-prompts.md)（中）: 後段へ渡したデータの内容が、前段の定めた区切りそのものを再現して枠を越える

## 13. 暫定の値と再評価キュー

暫定の値はない（新設候補は §12）。

## 14. サイクルの計器（次のサイクルで弱い段を選ぶための分布。目標値・KPI にしない）

読み方の正本は [改善サイクル §5](../architecture/improvement_cycle.md)。月は `recorded_at` の年月。件数は本索引だけが持ち、エントリ・辞書・規約文書には書かない。

### 14.1 型の再発（月をまたいで出る型）

| 型 | 2026-07 | 2026-08 | 2026-09 |
|---|---|---|---|
| `duplicate-canonical-sources` | 2 | 4 | 2 |
| `doc-drifts-from-code` | 1 | 1 | 1 |
| `information-dropped-as-unrepresentable` | 2 |  | 5 |
| `condition-not-propagated` | 3 |  | 3 |
| `available-but-unwired` | 2 |  | 3 |
| `completion-defined-by-proxy` | 2 |  | 3 |
| `guardrail-does-not-cover-new-path` | 1 |  | 4 |
| `contract-changed-one-side` | 1 |  | 2 |
| `unaudited-write-path` | 1 |  | 2 |
| `external-budget-exceeded` |  | 1 | 1 |
| `full-update-clobbers-unrelated-fields` | 1 | 1 |  |
| `last-mile-missing` | 1 |  | 1 |
| `stale-derivative-served` | 1 | 1 |  |

単一の月にだけ出た型: `ai-decides-instead-of-human`, `context-lost-across-execution-boundary`, `default-hides-choice`, `delete-cascade-loses-derived-records`, `destructive-action-without-confirmation`, `disclosure-not-declared`, `domain-vocabulary-hardcoded`, `entry-point-proliferation`, `entry-scope-mismatch`, `failure-reported-as-success`, `fallback-fabricates-missing-link`, `gate-position-wrong`, `id-namespace-conflated`, `id-not-stable-across-versions`, `id-unique-only-within-inner-scope`, `negative-decision-second-class`, `permission-and-affordance-asymmetric`, `projection-mistaken-for-source`, `reexecution-overwrites-human-decision`, `referenced-source-does-not-exist`, `replay-conflicts-with-history`, `same-name-different-referents`, `scope-widened-silently`, `substring-match-false-positive`, `test-pins-implementation-text`, `threshold-reused-across-regimes`, `unchecked-type-contract-at-boundary`, `unit-of-work-undefined`, `untrusted-input-reaches-instruction`, `wording-mismatch`

### 14.2 発見観点の月別分布（偏りを見る）

| 発見観点 | 2026-07 | 2026-08 | 2026-09 |
|---|---|---|---|
| `symptom_report` | 4 | 5 | 5 |
| `invariant_audit` | 6 |  | 24 |
| `boundary_walk` | 8 |  | 8 |
| `doc_code_diff` | 5 | 5 | 5 |
| `data_inspection` |  | 2 | 17 |
| `trace_walk` | 5 | 2 | 19 |
| `adversarial_review` | 4 | 2 | 11 |
| `inventory` | 10 | 6 | 16 |
| `guardrail_failure` | 2 |  | 5 |
| `reproduction` |  | 1 | 4 |
| `external_constraint` |  | 1 | 2 |

一度も使われていない観点: （なし）

### 14.3 サイクル層のエントリ（改善サイクル自身の課題）

| ID | 題名 | 群 | 処理 | 構造 | 接続 | 統制 | 原因の確度 | 分類 | 状態 | 型 | 発見観点 | 解決観点 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| [IK-0325](entries/IK-0325-improvement-cycle-canonical-outside-repo.md) | 改善サイクルの手順の正本が実行者の外部記憶にあり、サイクル自身の課題を記帳する対象範囲と層の語彙が無い | 構造・接続・統制 | — | representation+aggregation | — | review | 確定 | 候補 | 解決済み | `information-dropped-as-unrepresentable` | invariant_audit, inventory | canonical_source, explicit_contract |

- `cycle_discovery`: （該当なし）
- `cycle_triage`: [IK-0325](entries/IK-0325-improvement-cycle-canonical-outside-repo.md)
- `cycle_design`: （該当なし）
- `cycle_implementation`: （該当なし）
- `cycle_verification`: （該当なし）
...
| [docs/architecture/improvement_cycle.md](../../docs/architecture/improvement_cycle.md) | 1 |
...
| [docs/architecture/knowledge_structure_review_2026-09-12.md](../../docs/architecture/knowledge_structure_review_2026-09-12.md) | 21 |
...
| [docs/development_checklist.md](../../docs/development_checklist.md) | 9 |
...
| [docs/features/knowledge_objects_design.md](../../docs/features/knowledge_objects_design.md) | 13 |
...
| [docs/issue_knowledge/entries/IK-0324-sql-percent-escape-written-for-one-consumer.md](../../docs/issue_knowledge/entries/IK-0324-sql-percent-escape-written-for-one-consumer.md) | 2 |
