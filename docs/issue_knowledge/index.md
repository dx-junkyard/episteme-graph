...
| 処理軸 | 値あり 12（延べ）/ none 77 / unknown 0 |
| 構造軸 | 値あり 76（延べ）/ none 18 / unknown 1 |
| 接続軸 | 値あり 52（延べ）/ none 41 / unknown 0 |
| 統制軸 | 値あり 64（延べ）/ none 38 / unknown 0 |
| 値を持つ軸の数 | 0軸 0 / 1軸 13 / 2軸 62 / 3軸 12 / 4軸 1 |
...
- 接続軸 低: [IK-0308](entries/IK-0308-arxiv-call-budget-and-429-loop.md), [IK-0319](entries/IK-0319-no-immutable-conversation-log.md), [IK-0320](entries/IK-0320-untrusted-source-text-in-prompts.md) ／ 中: 46 件
- 統制軸 低: （該当なし） ／ 中: 48 件
