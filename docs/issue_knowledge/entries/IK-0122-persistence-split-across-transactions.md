...
history:
  - date: '2026-09-19'
    ...
    from: primary=structure facets=[structure.decomposition, governance.resume]
    to: axes=processing=[none]; structure=[decomposition]; connection=[none]; governance=[resume]
